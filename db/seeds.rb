...
ProductTable.delete_all
ProductTable.create!(title: 'Docker for Rails Developers',
  description:
    %{<p>
...
ProductTable.create!(title: 'Build Chatbot Interactions',
  description:
    %{<p>
...
ProductTable.create!(title: 'Programming Crystal',
  description:
    %{<p>
